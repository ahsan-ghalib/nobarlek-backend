...
use App\Jobs\CompetitionScrapperJob;
...
class CompetitionScrapperCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'data-scrapping:competition-scrapper-command';
     ...
     * @var string
     */
    protected $description = 'Scrap the competitions data from the api resource';
    ...
    {
        dispatch(new CompetitionScrapperJob());
    }
}
