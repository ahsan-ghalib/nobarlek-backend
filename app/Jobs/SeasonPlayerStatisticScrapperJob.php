...
class SeasonPlayerStatisticScrapperJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        $seasonIds = FootballData::query()
            ...
            ->where('data_type', '=', DataUpdatesTypeEnum::SEASON_PLAYER_STATISTICS->value)
        ...
        foreach ($seasons as $seasonId) {
            (new SeasonPlayerStatisticsScrapingService())->scrapNewestSeasonPlayerStatisticData(['uuid' => $seasonId->season_id]);
        }
    }
}
